...
def save_image(image):
    ...
    _, fext = os.path.splitext(image.filename)
    image_filename = random_hex + fext
...
def account():
    ...
    return render_template(
        "account.html", title="Account", profile_pic=profile_pic, form=form
    )
...
def user_posts(username):
    ...
    profile_pic = url_for("static", filename=f"profile_pics/{user.profile_picture}")
    posts = (
